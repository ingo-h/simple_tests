...
// Author: 2021-03-09 Ingo Höft <Ingo@Hoeft-online.de>, last modify 2025-08-26

// Compile with: /usr/bin/g++ -pedantic-errors -Wall -o use_select.a
// use_select.cpp
...
int mysocket(char* a_ipaddr, int a_port) {
    ...
    // Monitor and select incoming connection on a socket
    fd_set readSet;
    FD_ZERO(&readSet);
